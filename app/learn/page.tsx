    ...
    <AppChrome userName={session.user.name} active="learn">
      <div className="learn-shell">
        <section className="learn-hero">
          ...
          <h1>Quatre pistes, un seul élan.</h1>
          <p className="learn-hero-sub">
            Code, Python, Physique, Maths. Leçons courtes, simulations vivantes, quiz. Gagne des points d’XP et débloque des badges.
          </p>
          <div className="xp-card">
            <div className="xp-head">
              <div>
                <p className="legal-eyebrow">Niveau {level}</p>
